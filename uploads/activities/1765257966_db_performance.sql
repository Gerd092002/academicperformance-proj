...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2025 at 05:56 AM
...
INSERT INTO `activities` (`id`, `subject_id`, `title`, `description`, `due_date`, `created_by`, `name`, `type`, `created_at`, `total_points`) VALUES
(4, 1, NULL, NULL, NULL, NULL, 'Create a Program', '', '2025-12-09 03:42:35', 100);
...
(1, 1, 'There is a bagyo', '', '2025-12-09 04:18:01');
...
INSERT INTO `assignments` (`id`, `subject_id`, `name`, `description`, `due_date`, `total_points`, `created_at`) VALUES
(2, 1, 'Make a Batch File', '.bat file', '2003-05-16', 100, '2025-12-09 03:41:52');
...
INSERT INTO `projects` (`id`, `subject_id`, `title`, `name`, `description`, `due_date`, `created_by`, `created_at`, `total_points`) VALUES
(2, 1, NULL, 'Final Project', 'Create a program', '2025-12-25', NULL, '2025-12-09 03:42:21', 100);
...
(2, 5, 1, 'approved', '2025-12-09 01:44:23'),
(3, 6, 1, 'approved', '2025-12-09 04:02:28'),
(4, 4, 1, 'approved', '2025-12-09 04:04:12');
...
(1, 'Itec123', 3, '2025-12-08 14:53:36'),
(2, 'Itec123', 3, '2025-12-09 01:43:01'),
(3, 'Itec145', 3, '2025-12-09 01:43:08'),
(4, 'ScSc12', 3, '2025-12-09 01:43:15');
...
INSERT INTO `submissions` (`id`, `assignment_id`, `activity_id`, `project_id`, `student_id`, `file_path`, `score`, `teacher_comment`, `created_at`, `feedback`, `submitted_at`) VALUES
(16, NULL, 4, NULL, 6, '1765254003_image.png', NULL, NULL, '2025-12-09 04:20:03', NULL, '2025-12-09 12:20:03');
...
(1, 'admin', 'admin@example.com', '$2y$10$wH9Ucb.7g4Z72klG4/7QwOZxKFlZf6Hq3cGfOQx2Vg7YfXl6Z2heC', 1, '2025-12-08 14:52:00'),
(2, 'jef', 'jef@gmail.com', '$2y$10$WXSE03mKdFvDK3/d0UmqweOHFm6u00QA8eZ1BdDU/eb72YDv1ZjJS', 1, '2025-12-08 14:52:00'),
(3, 'teacher1', 'teacher1@gmail.com', '$2y$10$GA3c1MwVNc3IDlJoWAXb7eBdDeTDHaYBbuQeBExceUpcrlImqxw7a', 2, '2025-12-08 14:52:00'),
(4, 'student1', 'student1@gmail.com', '$2y$10$rnUMQ0mbcILcs3CQ1nDZv.7d8.ku.Zw.IMdWIEQEpYR9M5MsTTfq.', 3, '2025-12-08 14:52:00'),
(5, 'student2', 'student2@gmail.com', '$2y$10$6UzelEkQE5qj0ZV2PF7nE.QBpAvArmlt5Q/dgjHpAt92yn5IX/Gtm', 3, '2025-12-09 01:41:56'),
(6, 'student3', 'student3@gmail.com', '$2y$10$ZqO04Ij113nzg7VVB97SxOt.X3/VL.aUic91R.tiKdpNJAuRxsDuK', 3, '2025-12-09 04:02:12');
